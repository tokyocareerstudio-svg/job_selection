...
(function () {
  ...
  const TOC = [
    ...
    { id: "industry", label: "📋 업계 리포트 라이브러리", file: "industry-index.html", children: [
      { label: "── IT·인터넷·컨설팅",  file: "industry-index.html", isHeader: true },
      { label: "SIer",                 file: "sier-report.html" },
      { label: "인터넷·웹",            file: "internet-report.html" },
      { label: "컨설팅",              file: "consulting-report.html" },
      { label: "── 전기·기계·소재",    file: "industry-index.html", isHeader: true },
      { label: "전기메이커",           file: "electric-maker-report.html" },
      { label: "중공업",               file: "heavy-report.html" },
      { label: "정밀기기",             file: "precision-report.html" },
      { label: "자동차메이커",         file: "car-maker-report.html" },
      { label: "소재메이커",           file: "material-report.html" },
      { label: "── 식품·소비재·제약",  file: "industry-index.html", isHeader: true },
      { label: "소비재・생활용품",      file: "consumer-report.html" },
      { label: "화장품・뷰티",         file: "cosmetics-report.html" },
      { label: "식품메이커",           file: "food-report.html" },
      { label: "음료메이커",           file: "beverage-report.html" },
      { label: "제약",                 file: "pharma-report.html" },
      { label: "── 상사·소매·유통",    file: "industry-index.html", isHeader: true },
      { label: "종합・전문상사",        file: "trading-report.html" },
      { label: "소매・유통",           file: "retail-report.html" },
      { label: "아파렐",              file: "apparel-report.html" },
      { label: "부동산(리테일・디벨로퍼)", file: "developer-report.html" },
      { label: "── 광고·미디어·게임",  file: "industry-index.html", isHeader: true },
      { label: "광고대리점",           file: "ad-agency-report.html" },
      { label: "TV방송·출판",          file: "media-report.html" },
      ...
      { label: "── 통신·인프라·물류·건설", file: "industry-index.html", isHeader: true },
      { label: "통신",                 file: "telecom-report.html" },
      { label: "에너지・인프라",        file: "energy-report.html" },
      { label: "물류",                 file: "logistics-report.html" },
      { label: "건설",                 file: "construction-report.html" },
      { label: "운수(항공·철도·해운)", file: "transport-report.html" },
      { label: "── 서비스·HR",        file: "industry-index.html", isHeader: true },
